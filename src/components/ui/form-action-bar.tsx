    ...
    >
      ...
      {onCancel && (
        <button
          ...
          className="min-w-[120px] px-8 py-2.5 rounded-lg bg-[#e72424] hover:bg-[#b11e1e] text-white text-sm font-semibold transition-all cursor-pointer shadow-xs focus:outline-none focus:ring-2 focus:ring-red-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {cancelLabel}
        </button>
      )}
