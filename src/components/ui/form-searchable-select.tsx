...
export function FormSearchableSelect({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-full flex flex-col", wrapperClassName)}
    >
      {label && (
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute left-0 right-0 top-[calc(100%+4px)] z-50 rounded-xl border border-slate-200 bg-white p-2 shadow-lg animate-in fade-in-0 zoom-in-95 duration-100">
          {/* Inner Search Box */}
